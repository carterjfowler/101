...
int main() {
    ...
    while (true) {
        ...
        bool show_word_count = get_yesno("Would you like a running total of words left in the list (y/n)?");
        cout << endl;
        ...
        while (!game.is_won() && !game.is_lost()) {
            ...
            if(show_word_count) {
                //show number of words in list
                cout << "The list currently has " << game.get_list_size() << " words in it." << endl;
            }
